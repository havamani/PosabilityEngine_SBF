...
//		{
//			hexString=hexString.replaceAll(hexString.charAt(j)+"", ISOUtil.alpha2Hex(hexString.charAt(j)+""));	
//		}
//		}
...
//		hexString="40345678231234563D030912312345000";
	 ...
	 * @Return String
	 */
	public static String leftPadZeros(final String ilosgStr, final int ilonuLength) {
